-- Finding What SQL Statements are Currently Executing
	...
	-- Step 1 
	-- * http://buildingbettersoftware.blogspot.com/2016/04/what-statements-are-running-in-my-sql.html

	-- Step 1.1 
	-- * Get a list of statements that are running in your SQL Server database right now.
	-- * You can also use this query to look for any long running or blocked statements
	SELECT
