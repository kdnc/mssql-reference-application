-- Finding the Slowest, Most Expensive SQL Statements
	...
	-- Step 1 
	-- * http://buildingbettersoftware.blogspot.com/2016/04/finding-most-expensive-longest-running.html

	-- Step 1.1 
	-- * The statement below gives us a good idea of what statements are being run from our application, how often, how long they take and how many resources they use on average.
	SELECT TOP 20
